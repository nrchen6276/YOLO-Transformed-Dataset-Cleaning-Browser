...
SCRIPT_PATH = (
    ...
    / "Dataset"
    / "Select_Programme"
    / "CIVL7009_source_group_picker_gui_V1.7_202606040155.py"
)
...
class ManualReviewSourcePickerTests(unittest.TestCase):
    ...
    def test_gui_issue_details_include_prefix_and_filenames(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            _summary, rows = manualreview_gui_v14.audit_review_dir(img, create_missing=True)
            details = "\n".join(manualreview_gui_v14.build_gui_issue_detail_lines(rows))
    ...
    def test_yolo_audit_images_labels_root_and_initialise(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            audit = manualreview_gui_v14.audit_yolo_dataset(root)
            ...
            result = manualreview_gui_v14.initialise_manualreview_from_yolo(audit)
