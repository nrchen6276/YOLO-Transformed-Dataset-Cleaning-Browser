...
from civl7009_picker_v3_0_1.app import MainWindow
from civl7009_picker_v3_0_1.assets import AssetService
from civl7009_picker_v3_0_1.manual_objects import ManualObjectsIndexService, ManualObjectsService, sha256_file
from civl7009_picker_v3_0_1.paths import ASSET_DIR
...
class V301Tests(unittest.TestCase):
    ...
    def test_manual_group_lazy_load_save_and_auto_next(self) -> None:
        with TemporaryDirectory() as tmp:
            root = Path(tmp) / "Manual_Objects"
