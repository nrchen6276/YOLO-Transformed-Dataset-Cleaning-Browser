...
datas = [
    ...
    (
        str(programme_dir / "UI_Assets" / "V1.9_202606041626"),
        "UI_Assets/V1.9_202606041626",
    ),
]
...
a = Analysis(
    ["D:\\P\\CIVL7009\\Dataset\\Select_Programme\\CIVL7009_source_group_picker_qt_V1.9_202606041626.py"],
    pathex=[],
    binaries=[],
    datas=datas,
    hiddenimports=[
...
exe = EXE(
    ...
    a.datas,
    [],
    name="CIVL7009_Source_Group_Picker_V1.9_202606041626",
    debug=False,
